        ...
        <div class="container">
          ...
          <div class="feature-grid">
            <div class="feature">
              ...
              <div>
                <a href="bridalGownUs.php" class="btn_hover2">View More</a>
              </div>
            </div>
            <div class="feature">
              <h3>Groom Suits</h3>
              ...
              <div>
                <a href="groomSuitUs.php" class="btn_hover2">View More</a>
              </div>
            </div>
            <div class="feature">
              ...
              <div>
                <a href="invitationUs.php" class="btn_hover2">View More</a>
              </div>
            </div>
            <div class="feature">
              ...
              <div>
                <a href="weddingPackageUs.php" class="btn_hover2">View More</a>
              </div>
            </div>
          </div>
        </div>
